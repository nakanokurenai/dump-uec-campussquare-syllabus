...
export const record = <Key extends keyof any, Value>(
	keyTransformer: Transformer<any, Key>,
	valueTransformer: Transformer<unknown, Value>
) =>
	Transformer.from<unknown, Record<Key, Value>>((u) => {
